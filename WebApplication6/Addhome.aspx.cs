...
namespace WebApplication6
{
    public partial class Addhome : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@category", ListBox1.Text);
            cmd.Parameters.AddWithValue("@type", ListBox2.Text);

            cmd.Parameters.AddWithValue("@houseno", TextBox7.Text);
            cmd.Parameters.AddWithValue("@address", TextBox8.Text);
            cmd.Parameters.AddWithValue("@amount", TextBox9.Text);
            cmd.Parameters.AddWithValue("@status", ListBox3.Text);
