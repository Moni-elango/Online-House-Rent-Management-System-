<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="confirm.aspx.cs" Inherits="WebApplication6.confirm" %>
      ...
      <form id="form1" runat="server">
						...
						<center>	<h1 style="text-align: center">&nbsp;</h1>
                                ...
                                <table style="width: 62%; height: 472px;">
                                    <tr>
                                        <td rowspan="13" style="width: 184px; background-color: #003366;">
                                            <asp:Image ID="Image1" runat="server" Height="200px" Width="200px" />
                                        </td>
                                        <td style="font-weight: bold; font-size: medium; background-color: #003366"><span class="text-white">Book ID</td>
                                    ...
                                    <tr class="text-white" style="font-weight: bold; font-size: medium">
                                        <td style="background-color: #003366">
                                            <asp:Button ID="Button1" runat="server" CssClass="text-white" OnClick="Button1_Click1" style="background-color: #009933" Text="Confirm Booking" />
