<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"  CodeFile ="Login.aspx.cs" Inherits="WebApplication6.Login" %>
...
<style type="text/css">
    ...
    <tr>
        <td class="auto-style9">
            <span class="auto-style11">UserLogin </span><b><br class="auto-style12" />
            </b>
            <br />
        </td>
    </tr>
    ...
    <tr>
        <td style="text-align: center; color: Green" class="auto-style29">
            Dont have Email and Password
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/newuser.aspx">Register Now !!</asp:HyperLink>
        </td>
    </tr>
</table></center>
</form>
